...
from YTauto.audio.edge_voice_module import EdgeTTSVoiceModule
from YTauto.audio.eleven_voice_module import ElevenLabsVoiceModule
from YTauto.config.api_db import ApiKeyManager
from YTauto.config.languages import (EDGE_TTS_VOICENAME_MAPPING,
                                        ELEVEN_SUPPORTED_LANGUAGES,
                                        LANGUAGE_ACRONYM_MAPPING,
                                        Language)
from YTauto.engine.content_video_engine import ContentVideoEngine
from YTauto.gpt import gpt_chat_video
...
class VideoAutomationUI(AbstractComponentUI):
    def __init__(self, YTautoUI: gr.Blocks):
            ...
            if self.state == Chatstate.ASK_ORIENTATION:
                ...
                if "yes" in message.lower():
                    ...
                    try:
                        ...
                        current_url = self.YTautoUI.share_url+"/" if self.YTautoUI.share else self.YTautoUI.local_url
    ...
    def initialize_conversation(self):
        ...
        self.video_html = ""
        self.videoVisible = False
        return [[None, "🤖 Welcome to YTauto! 🚀 I'm a python framework aiming to simplify and automate your video editing tasks.\nLet's get started! 🎥🎬\n\n Do you want your video to be in landscape or vertical format? (landscape OR vertical)"]]
