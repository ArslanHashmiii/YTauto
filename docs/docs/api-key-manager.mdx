---
title: ApiKeyManager in YTauto
sidebar_label: ApiKeyManager
---

# ApiKeyManager in YTauto

ApiKeyManager is a class in the YTauto framework that manages the API keys for different providers. It interacts with the database to get and set API keys.
