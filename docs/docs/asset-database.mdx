---
title: AssetDatabase in YTauto
sidebar_label: AssetDatabase
---

# AssetDatabase in YTauto

The `AssetDatabase` in YTauto is a powerful tool that allows you to manage both local and remote assets. This guide will provide you with examples of how to use the `AssetDatabase`.
