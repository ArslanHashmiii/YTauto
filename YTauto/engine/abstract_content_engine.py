...
from YTauto.config.path_utils import get_program_path
from YTauto.database.content_database import ContentDatabase
...
class AbstractContentEngine(ABC):
    ...
    def initializeFFMPEG(self):
        ...
        if not ffmpeg_path:
            raise Exception("FFmpeg, a program used for automated editing within YTauto was not found on your computer. Please go back to the README and follow the instructions to install FFMPEG")
