from YTauto.utils.requirements import Requirements
...
d8'   .8P 88     88  Y8.   .8P   88     88    88    Y8.   .88  88           88
 Y88888P  dP     dP   `8888P'    dP     dP    dP     `88888'   dP           dP
        ...
        ''')
        CLI.display_green_text("Welcome to YTauto! This is an experimental AI framework to automate all aspects of content creation.")
        print("")
    ...
    def display_help():
        '''Display help'''
        print("Usage: python YTauto.py [options]")
        print("")
        print("Options:")
    ...
    def display_error(error_message, stack_trace):
        ...
        print("Get Help on Discord : https://discord.gg/ZhYkPHAm")
